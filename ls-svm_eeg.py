...
if __name__ == '__main__':
    ...
    print("LS-SVM", str(acc_linear_svc) + '%')
    print("Confusion matrix")
    print(confusion_matrix(y_test, y_pred_linear_svc, labels=[1, 0]))
    CM = confusion_matrix(y_test, y_pred_linear_svc, labels=[1, 0])
    ...
    print("Recall", recall)
    f1 = f1_score(y_test, y_pred_linear_svc, zero_division=1)
    print("F1 score : ", f1)
